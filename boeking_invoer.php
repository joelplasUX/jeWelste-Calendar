...
Datum</td>
<td><input type="date" name="datum" size="20" value="<?php
    echo date("d-m-Y");
?>"> </td></tr>
<tr><td class="cms">
Status</td>
...
<td colspan="2"><input type="text" name="plaats" size="60" maxlength="100"></td></tr>
	<tr><td class="cms">
Telefoon</td>
<td colspan="2"><input type="tel" name="telefoon" size="60" maxlength="100"></td></tr>
	<tr><td class="cms">
Contactpersoon</td>
...
<td colspan="2"><input type="text" name="boeking" size="60" maxlength="100"></td></tr>
	<tr><td class="cms">
P.A. opbouw</td>
<td colspan="2" class="overzicht"><input type="time" name="pa_opbouw"/>
uur</td>
	</tr>
	<tr><td class="cms">
Band opbouw</td>
<td colspan="2" class="overzicht"><input type="time" name="band_opbouw" />
uur</td>
	</tr>
	<tr><td class="cms">
Soundcheck</td>
<td colspan="2" class="overzicht"><input type="time" name="soundcheck" />
uur</td>
	</tr>
	<tr><td class="cms">
Eettijden</td>
<td colspan="2" class="overzicht"><input type="time" name="eettijden" />
uur</td>
	</tr>
	<tr><td class="cms">
Spelen tussen</td>
<td colspan="2" class="overzicht"><input type="time" name="spelen" />
uur - <input type="time" name="eindtijd" /> uur</td>
	</tr>
<tr><td class="cms">
Sets</td>
...
Eten</td>
	...
	<tr><td class="cms">
Gage Band</td>
<td colspan="2" class="overzicht"><input name="gage_band" type="number" size="10" maxlength="100">
Euro</td>
	</tr>
	<tr><td class="cms">
Gage Jo�l</td>
<td colspan="2" class="overzicht"><input name="gage_joel" type="number" size="10" maxlength="100">
  Euro</td>
	</tr>
