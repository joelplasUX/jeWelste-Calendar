...
$body .= "Plaats :".$plaats."\n";
$body .= "Spelen :".$spelen;
$body .= "Agendabestand : <a href=\"http://www.joelsoundsupport.nl/jewelste/agenda/".$file."\">PC</a> of <a href=\"http://www.joelsoundsupport.nl/jewelste/agenda/".$file_mac."\">Apple</a>";

//$attachment = fread(fopen($file, "r"), filesize($file)); 
//$attachment2 .= fread(fopen($file_mac, "r"), filesize($file_mac));
$mail = new mime_mail();
$mail->from = "agenda@jewelste.nl";
$mail->headers = "Errors-To: [EMAIL=joel@jewelste.nl]Joël Plas[/EMAIL]";
$mail->to = "agenda@jewelste.nl";
